    ...
    <div class="input-form">
      <form @submit="submitForm" class="ui form">
       <div class="field">
        ...
        <span :style="styling">{{ fieldErrors.newItem }}</span>
       ...
       <div class="field">
        ...
        <span :style="styling">{{ fieldErrors.email }}</span>
       </div>
       <div class="field">
        <label>Urgency</label>
        ...
        <span :style="styling">{{ fieldErrors.urgency }}</span>
       ...
       <div class="field">
        <div class="ui checkbox">
          ...
          <span :style="styling">{{ fieldErrors.termsAndConditions }}</span>
        </div>
       </div>
